 ...
 * https://www.lmfit.com.br/ (snapshot ~Apr 2026). Static fixtures only — not synced to the live site.
 */

export const DEMO_SEED_SENTINEL_NOTES = 'SEED_LMFIT_DEMO';
...
export const Suppliers: SupplierFixture[] = [
  {
    name: 'LMFIT Atelier — Produção',
    email: 'producao@lmfit.com.br',
...
export const Purchases: PurchaseFixture[] = [
  ...
  {
    supplierIndex: 1,
    reference: 'Bolsa Sacola Esportiva LMFIT — brindes',
    total: 25 * 30,
    status: 'pending',
